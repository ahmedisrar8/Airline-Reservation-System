...
public partial class ticket : System.Web.UI.Page
{
    ...
    {
        con.Close();
        SqlCommand cmd = new SqlCommand("select * from ars_planes", con);
        con.Open();
        ...
        while (dr.Read())
        {
            ...
            plane_num[n1] = dr["plane_num"].ToString();
            airport_code[n1] = dr["airport_code"].ToString();
            n1++;
    ...
    private void insertkhitoisl(string d,string dtime, string atime, int i)
    {
        string fn = fng();
        string ddate = d;
       
        SqlCommand cmd = new SqlCommand("insert into ars_flights values ('" + fn + "','" + ddate + "','" + dtime + "','" + ddate + "','"+atime+"',(select price from ars_prices where distance = 'KHIISL'),'AR-ISL-001','" + airport_code[i] + "','" + plane_num[i] + "','Active')", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
    }
