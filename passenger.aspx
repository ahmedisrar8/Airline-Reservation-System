<%@ Page Title="" Language="C#" MasterPageFile="main.master" AutoEventWireup="true" CodeFile="passenger.aspx.cs" Inherits="view_schedule" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <title>View Passenger - Bahria Airways</title>
    ...
    <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">View Passenger</h4> </div>
                    <%--  --%>
                    <!-- /.col-lg-12 -->
                </div>
...
<div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-20">Bahria Airways Passenger List For Ticket <% Response.Write("<b>"+date+"</b>"); %></p>
