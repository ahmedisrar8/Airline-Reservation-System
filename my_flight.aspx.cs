    ...
    public string getdata()
    {
       ...
       /* try
        ...
        string dloc = "", aloc = "" , dur = "1 Hour and 45 Minutes", clas = "", clas1 = "";
            ...
            SqlCommand cmd = new SqlCommand("select * from v_ars_flight_ticket where uname = '" + Session["id"].ToString()+ "' and ars_status = 'Confirmed' order by d_date asc", con);
            con.Open();
            ...
            if(dr["status"].ToString() == "Active")
            {
                ...
                if (dr["ars_status"].ToString() == "Confirmed")
                {
                    clas1 = "success";
                }
