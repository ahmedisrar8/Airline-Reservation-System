<%@ Page Title="" Language="C#" MasterPageFile="main.master" AutoEventWireup="true" CodeFile="find_flight.aspx.cs" Inherits="view_schedule" %>
    ...
    <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Find Flight</h4> </div>
                    <%--  --%>
                    <!-- /.col-lg-12 -->
                </div>
