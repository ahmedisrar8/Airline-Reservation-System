<%@ Page Title="" Language="C#" MasterPageFile="main.master" AutoEventWireup="true" CodeFile="booking.aspx.cs" Inherits="view_schedule" %>
    ...
    <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">View Bookings</h4> </div>
                    <%--  --%>
                    <!-- /.col-lg-12 -->
                </div>
...
<div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            ...
                            <p class="text-muted m-b-20">Bahria Airways Bookings For Flight <% Response.Write("<b>"+date+"</b>"); %></p>
